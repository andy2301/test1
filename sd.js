$(document).ready(function(){
  ...
  parseSdealDate = function(dateStr, timeStr, TODAY = new Date(), hourZoneShift = -1) {
  ...
  $("#reset").click(function(e) {
    ...
    for (var i=0; i<trArr.length; i++) $(trArr[i]).removeAttr("style");
    $('#filterLabel').html('');
  });
  ...
  filterClick = function() {
    var scoreT=1, viewsT=10, repliesT=0, votesT=0;
  ...
  filterApply = function(scoreT = 2, viewsT = 10, repliesT = 0, votesT = 0) {
    var trArr = $("#threadbits_forum_9").children();
    var items = [];
    var k = 0;
